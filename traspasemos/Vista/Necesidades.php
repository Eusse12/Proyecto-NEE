                ...
                <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <p><strong>paraplejia:</strong>Afecta las piernas y parter del cuerpo por lesiones en la médula espianl.</p>
                                <p><strong>tetraplejia:</strong>Afecta las cuatro extremidades y el torso por lesiones en la médula espinal alta.</p>
                                <p><strong>lesiones medulares:</strong>Causa pérdida de movilidad y sensibildad según el nivel afectado</p>
                                <p><strong>Hemiplejia:</strong>Parálisis de un lado del cuerpo, generalmente tras un accidente cerebrovascular</p>
                                <p><strong>Espina Bífida:</strong>Malforamación de la columna vertebral que limita la movilidad</p>
                            </div>
                        </div>
                    </div>
            </div>
