...
<div class="sidebar">
    ...
    <a href="tipo_usuario.php" class="bg-white text-dark rounded"><i class="fas fa-user-graduate"></i> Estudiantes</a>
    <a href="remision.php"><i class="fas fa-file-alt"></i> Remisiones</a>
    <a href="aspecto_academico.php"><i class="fas fa-book"></i> Académicos</a>
    <a href="aspecto_complementario.php"><i class="fas fa-puzzle-piece"></i> Complementarios</a>
    <a href="grado.php"><i class="fas fa-layer-group"></i> Grados</a>
    <a href="grupo.php"><i class="fas fa-users-cog"></i> Grupos</a>
</div>
